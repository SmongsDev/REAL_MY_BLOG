        ...
        <>
            <footer className="body-font">
                <div className="mx-auto max-w-3xl px-4 sm:px-6 xl:max-w-6xl xl:px-0">
                    ...
                    <p className="text-sm text-gray-500 sm:ml-6 sm:mt-0 mt-4">© 2023 made by 
                        <a href="https://google.com/search?q=smongs" rel="noopener noreferrer" className="text-gray-600 ml-1" target="_blank">@smongs</a>
                    </p>
                    <span className="inline-flex sm:ml-auto sm:mt-0 mt-4 justify-center sm:justify-start">
                        <Link href={"https://facebook.com/"} className="text-gray-500" target="_blank">
                            <svg fill="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="w-5 h-5" viewBox="0 0 24 24">
                                <path d="M18 2h-3a5 5 0 00-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 011-1h3z"></path>
                            </svg>
                        </Link>
                        <Link href={"https://velog.io/@sssm0928"} className="ml-3 text-gray-500" target="_blank">
                        ...
                        <Link href={"https://instagram.com/mollang1102"} className="ml-3 text-gray-500" target="_blank">
                            <svg fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="w-5 h-5" viewBox="0 0 24 24">
                                <rect width="20" height="20" x="2" y="2" rx="5" ry="5"></rect>
                                <path d="M16 11.37A4 4 0 1112.63 8 4 4 0 0116 11.37zm1.5-4.87h.01"></path>
                            </svg>
                        </Link>
                        <Link href={"https://github.com/javascriptKR"} className="ml-3 text-gray-500" target="_blank">
